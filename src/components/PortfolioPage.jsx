      ...
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-12 px-6 py-12">
        <section className="grid gap-6 rounded-2xl border border-white/10 bg-white/5 p-8 md:grid-cols-3">
          <div className="md:col-span-2">
            ...
            <p className="mb-3 text-6xl md:text-5xl">
              {data.site.tagline}
            </p>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
            ...
            <div className="mb-8 border-l-2 border-blue-500 pl-6">
              <p className="text-lg leading-relaxed text-slate-300">
                {data.contact.professionalSummary}
              </p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1">
                ...
                <p className="text-slate-200 transition-colors hover:text-blue-400">
              ...
              <div className="space-y-1">
                ...
                <p className="text-slate-200">{data.contact.phone}</p>
              </div>

              <div className="sm:col-span-2 space-y-1">
                <span className="text-xs font-semibold uppercase tracking-wider text-slate-500">Location</span>
                <p className="text-slate-200">{data.contact.location || data.site.address}</p>
              </div>
            </div>
          </div>
        </section>
